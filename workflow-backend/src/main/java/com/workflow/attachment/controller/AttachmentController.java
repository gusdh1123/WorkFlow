...
//        String disposition = "attachment; filename=\"" + fallback + "\"; filename*=UTF-8''" + encoded;
//        
//        return disposition;
//    }
//    
//    // 다운로드용: Content-Type 처리
...
//        	
//            try { 
//                ct = MediaType.parseMediaType(contentType); 
//                return ct;
