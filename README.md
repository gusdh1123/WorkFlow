...
→ 복구 가능성을 유지하면서 스토리지 효율을 확보하기 위해, 2주 경과 후 자동 삭제되는 Scheduler를 도입하여 데이터 및 첨부 파일을 비동기적으로 정리하도록 개선
...
→ 충돌 빈도가 낮은 수정 환경에서 락 경합 없이 정합성을 확보할 수 있어 비관적 락 대신 version 기반 낙관적 락을 적용
