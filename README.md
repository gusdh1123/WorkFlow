...
## ℹ️ 주제 선정 이유
이전 프로젝트에서 사용자 중심의 기능 구현을 경험한 이후, 서비스의 사용성뿐만 아니라 내부 동작과 구조에 대한 관심이 생겼습니다.

이에 따라 권한 관리, 상태 전이, 변경 이력과 같은 비즈니스 로직을 직접 설계하고 구현해보고자 했습니다.

이를 가장 잘 담을 수 있는 주제가 사내 업무 관리 시스템이라 판단해 프로젝트를 진행하게 되었습니다.
